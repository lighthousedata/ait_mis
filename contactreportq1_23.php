...
<?php
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE indexinterviewdate>'2023-01-01' AND indexinterviewdate<'2023-04-01' ");
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE indexinterviewdate>'2023-01-01' AND indexinterviewdate<'2023-04-01' ");
...
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE facility LIKE '%$reportvalue%' AND indexinterviewdate > '2023-01-01' AND indexinterviewdate<'2023-04-01' ");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='gender'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE gender LIKE '%$reportvalue%'AND indexinterviewdate > '2023-01-01' AND indexinterviewdate<'2023-04-01'");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='mode'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE mode LIKE '%$reportvalue%' AND indexinterviewdate > '2023-01-01' AND indexinterviewdate<'2023-04-01'");
$numrows=mysql_num_rows($selectallpatients);

}else if($reportterm=='contnum'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE contnum LIKE '%$reportvalue%'AND indexinterviewdate > '2023-01-01' AND indexinterviewdate<'2023-04-01' ");
$numrows=mysql_num_rows($selectallpatients);
