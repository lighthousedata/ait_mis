...
<?php
$selectallpatients=mysql_query("SELECT * FROM contactsoutcomes WHERE outcomedate > '2021-09-30' AND outcomedate < '2022-01-01'");
...
if($reportterm=='none'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE outcomedate > '2021-09-30' AND outcomedate < '2022-01-01'");
...
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE facility LIKE '%$reportvalue%' AND outcomedate > '2021-09-30' AND outcomedate < '2022-01-01' ");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='gender'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE gender LIKE '%$reportvalue%' AND outcomedate > '2021-09-30' AND outcomedate < '2022-01-01'");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='outcome'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE outcome LIKE '%$reportvalue%' AND outcomedate > '2021-09-30' AND outcomedate < '2022-01-01'");
$numrows=mysql_num_rows($selectallpatients);

}else if($reportterm=='contnum'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE contnum LIKE '%$reportvalue%' AND outcomedate > '2021-09-30' AND outcomedate < '2022-01-01'");
$numrows=mysql_num_rows($selectallpatients);
