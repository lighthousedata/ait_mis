...
<?php
$selectallpatients=mysql_query("SELECT * FROM indexreg WHERE dateidentified >'2023-01-01' AND dateidentified <'2023-04-01'");
...
$selectallpatients=mysql_query("SELECT * FROM indexreg WHERE facility dateidentified >'2023-01-01' AND dateidentified <'2023-04-01' ");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='gender'){
$selectallpatients=mysql_query("SELECT * FROM indexreg WHERE dateidentified >'2023-01-01' AND dateidentified <'2023-04-01' and gender like ='$reportvalue' ");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='indexnum'){
$selectallpatients=mysql_query("SELECT * FROM indexreg WHERE indexnum dateidentified >'2023-01-01' AND dateidentified <'2023-04-01' ");
$numrows=mysql_num_rows($selectallpatients);
}
}?><center>
