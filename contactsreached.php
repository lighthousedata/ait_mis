...
<?php
$selectallpatients=mysql_query("SELECT * FROM reachedcontacts WHERE outcomedate between '2023-10-01' AND '2023-12-31' order by outcomedate");
...
$selectallpatients=mysql_query("SELECT * FROM reachedcontacts WHERE facility LIKE '%$reportvalue%' AND outcomedate between '2023-10-01' AND '2023-12-31' order by outcomedate");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='gender'){
$selectallpatients=mysql_query("SELECT * FROM reachedcontacts WHERE gender LIKE '%$reportvalue%' AND outcomedate between '2023-10-01' AND '2023-12-31' order by outcomedate");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='outcome'){
$selectallpatients=mysql_query("SELECT * FROM reachedcontacts WHERE outcome LIKE '%$reportvalue%'AND outcomedate between '2023-10-01' AND '2023-12-31' order by outcomedate");
$numrows=mysql_num_rows($selectallpatients);
