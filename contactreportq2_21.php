...
<?php
$selectallpatients=mysql_query("SELECT * FROM contacts where indexinterviewdate < '2022-07-01' AND indexinterviewdate > '2022-03-31'") ;
...
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE facility LIKE '%$reportvalue%' AND indexinterviewdate < '2022-07-01'AND indexinterviewdate > '2022-03-31'");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='gender'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE gender LIKE '%$reportvalue%' AND indexinterviewdate < '2022-07-01'AND indexinterviewdate > '2022-03-31'");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='mode'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE mode LIKE '%$reportvalue%' indexinterviewdate < '2022-07-01'AND indexinterviewdate > '2022-03-31'");
$numrows=mysql_num_rows($selectallpatients);

}else if($reportterm=='contnum'){
$selectallpatients=mysql_query("SELECT * FROM contacts WHERE contnum LIKE '%$reportvalue%' indexinterviewdate < '2022-07-01'AND indexinterviewdate > '2022-03-31'");
$numrows=mysql_num_rows($selectallpatients);
