...
<?php
$selectallpatients=mysql_query("SELECT * FROM indexreg WHERE dateidentified >'2022-05-31' AND dateidentified <'2022-09-01'");
...
$selectallpatients=mysql_query("SELECT * FROM indexreg WHERE facility dateidentified >'2022-05-31' AND dateidentified <'2022-09-01' ");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='gender'){
$selectallpatients=mysql_query("SELECT * FROM indexreg WHERE dateidentified >'2022-05-31' AND dateidentified <'2022-09-01' and gender like ='$reportvalue' ");
$numrows=mysql_num_rows($selectallpatients);
 }else if($reportterm=='indexnum'){
$selectallpatients=mysql_query("SELECT * FROM indexreg WHERE indexnum dateidentified >'2022-05-31' AND dateidentified <'2022-09-01' ");
$numrows=mysql_num_rows($selectallpatients);
}
}?><center>
